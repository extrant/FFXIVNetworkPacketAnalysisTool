...
namespace FFXIVNetworkPacketAnalysisTool.PacketStructures
{
    ...
    public struct UP_ClientTrigger
    {
        ...
        public ClientTriggerFlag ControlId => (ClientTriggerFlag)Flag;
        
        public string ControlIdName
        {
            get
            {
                if (System.Enum.IsDefined(typeof(ClientTriggerFlag), Flag))
                    return ((ClientTriggerFlag)Flag).ToString();
                return $"Unknown(0x{Flag:X4})";
            }
        }
    }
